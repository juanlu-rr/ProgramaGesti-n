...
public class ModeloModificacionViaje {
	...
	public void ModificacionViaje(Choice choice, TextField cadena1, TextField cadena2, TextField cadena3, Dialog dialogo, 
			...
			ModeloLogin.registrar(VistaLogin.txfUsuario.getText(), ("UPDATE viajes SET destino ='" + cadena2.getText() + "' WHERE idHotel=" + program1));
			ModeloLogin.registrar(VistaLogin.txfUsuario.getText(), ("UPDATE viajes SET fechaViaje ='" + cadena3.getText() + "' WHERE idHotel=" + program1));
